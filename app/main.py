...
import os
from app.routers import auth_routes, user_routes, post_routes, comment_routes, chat_routes, calendar_routes, budget_routes, voice_routes, vendor_routes, vendor_message_routes, vector_routes, sql_terminal_routes, admin_dashboard_routes, admin_docs_routes, admin_user_auth_routes, admin_vendor_management_routes, admin_vendor_approval_routes, admin_admin_approval_routes, couple_routes, invitation_routes, digital_invitation_routes, chat_memory_routes, model_routes, review_summary_routes
